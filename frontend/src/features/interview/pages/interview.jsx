            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    <div className="nav-content">
                        ...
                        <p className='interview-nav__label'>Analysis</p>
                        {NAV_ITEMS.map(item => (
                            <button
                                key={item.id}
                    ...
                    <button
                        onClick={() => alert("Resume export will be available soon.")}
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        <p className='match-score__label'>Alignment Score</p>
                        ...
                        <p className='match-score__sub'>
                            {report.matchScore >= 80 ? 'High alignment with role requirements' :
                             report.matchScore >= 60 ? 'Moderate alignment — address identified skill gaps' :
